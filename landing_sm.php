...
require_once('deleteMemberForm.php');
require_once('deleteMember.php');



$result = mysqli_query($con, "SELECT * FROM projects , equipe where equipe.id = projects.teamId");
$result_1 = mysqli_query($con, "SELECT * FROM users , equipe  where role ='member' and equipe.id = users.teamId  ");
...
<body class="bg-gradient-to-r from-indigo-500 to-green-500 bg-no-repeat h-fit	">
    <div class="centered-message">
        Welcome to you! <br> Scrum Master
    </div>
        ...
        <aside id="sidebar" class=" lg:flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 h-screeen	">
            <div class="flex flex-col justify-between flex-1 mt-6">
                <nav>
                    ...
                    <a href="login.php" id="logInButton" class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                        <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <td class="text-center px-4 py-4"><?php echo $row['project_name'] ?></td>
                                <td class="text-center px-4 py-4"><?php echo $row['description'] ?></td>
                                <td class="text-center px-4 py-4"><?php echo $row['deadline'] ?></td>
                                <td class="text-center px-4 py-4"><?php echo $row['team'] ?></td>
                            <?php
                        }
                            ?>
                    </tbody>
                                ...
                                <td class="px-4 py-4 text-sm ">
                                    <div class="flex items-center justify-center gap-x-6">
                                        <form method="post" action="deleteMemberForm.php">
                                            <input type="hidden" name="memberid" value="<?php echo $row['email']; ?>">
            ...
            <div class="relative overflow-x-auto shadow-md ">
                <table id="scrumMasterTable" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 hidden">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <td class="text-center px-4 py-4"><?php echo $row['firstname'] ?></td>
                                <td class="text-center px-4 py-4"><?php echo $row['lastname'] ?></td>
                                <td class="text-center px-4 py-4"><?php echo $row['phone'] ?></td>
                                <td class="text-center px-4 py-4"><?php echo $row['team'] ?></td>
                                <td class="text-center px-4 py-4"><?php echo $row['email'] ?></td>
